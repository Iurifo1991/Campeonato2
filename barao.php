...
<div>
<style type="text/css">
        thead{color:#ffff;background-color:hsl(0, 0.00%, 4.70%);}
        tbody{color:#000;background-color:rgb(243, 239, 236);}
 ...
 <table class="table" width="40%"  style="text-align: center;">
    ...
    <tbody>
        ...
        if ($user_data['jogador_time']== "Barao"){
            echo "<tr>";
    ...
    <tbody>
        <?php
          while($user_data2=mysqli_fetch_assoc($result2)){
            if ($user_data2['nome']== "Barao" && $user_data2['categoria']=='profissional'){
            echo "<tr>";
