...
<div>
<style type="text/css">
        thead{color:#ffff;background-color:rgb(245, 81, 5);}
        tbody{color:#ffff;background-color:rgb(10, 10, 10);}
    ...
    <tbody>
        <?php
          while($user_data=mysqli_fetch_assoc($result)){
            if ($user_data['jogador_time']== "União e Força"){
            echo "<tr>";
    ...
    <tbody>
        <?php
          while($user_data2=mysqli_fetch_assoc($result2)){
            if ($user_data2['nome']== "União e Força" && $user_data2['categoria']=='profissional'){
            echo "<tr>";
