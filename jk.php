...
<div>
<style type="text/css">
        thead{color:#ffff;background-color:rgb(1, 49, 35);}
        tbody{color:#ffff;background-color:rgb(87, 224, 7);}
    ...
    <tbody>
        <?php
          while($user_data2=mysqli_fetch_assoc($result2)){
            if ($user_data2['nome']== "JK" && $user_data2['categoria']=='profissional'){
            echo "<tr>";
