...
<div>
<style type="text/css">
        thead{color:#ffff;background-color:rgb(15, 15, 15);}
        tbody{color:#000;background-color: #ff6600;}
    ...
    <tbody>
        <?php
          while($user_data2=mysqli_fetch_assoc($result2)){
            if ($user_data2['nome']== "ADF" && $user_data2['categoria']=='profissional'){
            echo "<tr>";
